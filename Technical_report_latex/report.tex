...
A critical design feature is the inclusion of a \textbf{kinematic mounting scheme} for each galvanometer assembly. This acknowledges that perfect manufacturing and assembly are impractical and provides a necessary mechanism for fine-grained, post-assembly calibration. The mounts are designed with slotted holes and utilize a three-point screw adjustment system. This provides precise, independent control over the position and orientation of each axis, enabling the tuning of the inter-mirror distance (\(e\)) and ensuring perfect orthogonality after the system is fully assembled.

% INSERT FIGURE: Full CAD Assembly
\begin{figure}[H]
\centering
% \includegraphics[width=1.0\textwidth]{./images/your_full_assembly_cad.png} % Replace with your filename
\caption{CAD model of the complete dual-axis galvanometer assembly, illustrating the orthogonal arrangement, VCM actuators, and kinematic mounting points on the main baseplate.}
